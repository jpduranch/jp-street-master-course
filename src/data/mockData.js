...
export const plans = {
  free: {
    ...
    features: [
      ...
      "Chat general y Chilling Chat",
      "Comparte gráficos y haz preguntas",
      "Notebook con infografías y videos",
    ],
    cta: "Unirse Gratis",
  },
  vip: {
    id: "vip",
    name: "VIP Plan",
    tagline: "Acceso al contenido premium",
    ...
    features: [
      ...
      "VIP Room con Watchlist diaria",
      "Trade Recap diario",
      "Videos exclusivos",
      "Live Room Audio: ideas, preguntas y escáneres",
    ],
    cta: "Comenzar VIP",
  },
};
